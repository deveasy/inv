                    ...
                    <div class="nk-block-head">
                        <div class="nk-block-between g-3">
                            <div class="nk-block-head-content">
                                <h3 class="nk-block-title page-title">Purchases</h3>
                                ...
                                <div class="toggle-wrap nk-block-tools-toggle">
                                    ...
                                    <div class="toggle-expand-content" data-content="pageMenu">
                                        <ul class="nk-block-tools justify-between g-3">
                                            ...
                                            <li><a href="#" data-toggle="modal" data-target="#addInvoice" class="btn text-white bg-primary"><em class="icon ni ni-plus"></em><span>Add New</span></a></li>
                                        </ul>
                                    </div>
                                </div><!-- .toggle-wrap -->
                            </div><!-- .nk-block-head-content -->
                                        ...
                                        <tbody class="tb-odr-body">
                                            <tr class="tb-odr-item">
                                                <td class="tb-odr-info">
                                                    <span class="tb-odr-id"><a href="html/crm/invoice-details.html">#746F5K2</a></span>
                                            ...
                                            <tr class="tb-odr-item">
                                                <td class="tb-odr-info">
                                                    <span class="tb-odr-id"><a href="html/crm/invoice-details.html">#546H74W</a></span>
                                            ...
                                            <tr class="tb-odr-item">
                                                <td class="tb-odr-info">
                                                    <span class="tb-odr-id"><a href="html/crm/invoice-details.html">#87X6A44</a></span>
                                            ...
                                            <tr class="tb-odr-item">
                                                <td class="tb-odr-info">
                                                    <span class="tb-odr-id"><a href="html/crm/invoice-details.html">#326T4M9</a></span>
                                                    <span class="tb-odr-date">21 Jan 2019, 6 :12 am</span>
                                                </td>
                                                <td class="tb-odr-amount">
                                                    <span class="tb-odr-total">
