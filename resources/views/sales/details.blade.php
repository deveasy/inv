                    ...
                    <div class="nk-block-head">
                        <div class="nk-block-between g-3">
                            <div class="nk-block-head-content">
                                <h3 class="nk-block-title page-title">Invoice <strong class="text-primary small">#66K5W3</strong></h3>
                            ...
                            <div class="nk-block-head-content">
                                <a href="html/crm/expense-management.html" class="btn btn-outline-light bg-white d-none d-sm-inline-flex"><em class="icon ni ni-arrow-left"></em><span>Back</span></a>
                                <a href="html/crm/expense-management.html" class="btn btn-icon btn-outline-light bg-white d-inline-flex d-sm-none"><em class="icon ni ni-arrow-left"></em></a>
                            </div>
                        </div>
                    </div><!-- .nk-block-head -->
                    <div class="nk-block">
                                ...
                                <div class="invoice-head">
                                    ...
                                    <div class="invoice-desc">
                                        ...
                                        <ul class="list-plain">
                                            ...
                                            <li class="invoice-date"><span>Date</span>:<span>10 March 2021, 10:45pm</span></li>
                                        </ul>
                                    </div>
                                </div><!-- .invoice-head -->
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>#3H4J60</td>
                                                    <td>Customer Relationship Management - Regular License</td>
                                                    <td>$450.00</td>
                                                    <td>5</td>
                                                    <td>$2200.00</td>
                                                </tr>
