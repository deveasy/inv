...
<head>
    ...
    <meta name="description" content="Inventory Management system by Creace Technologies.">
    <!-- Fav Icon  -->
    <link rel="shortcut icon" href="./images/favicon.png">
    <!-- Page Title  -->
    <title>Login | Creace Inventory</title>
    <!-- StyleSheets  -->
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-lg-6">
                                    <div class="nk-block-content text-center text-lg-left">
                                        <p class="text-soft">&copy; <?php echo date("Y"); ?> Creace Technologies. All Rights Reserved.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
